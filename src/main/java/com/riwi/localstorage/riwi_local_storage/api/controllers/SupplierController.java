...
public class SupplierController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<SupplierResponse> getById(String id) {
        SupplierResponse response = supplierService.getById(id).orElse(null);
        return ResponseEntity.ok(response);
    }

    @GetMapping("/by-name/{name}")
    public ResponseEntity<SupplierResponse> getByName(String name) {
        SupplierResponse response = supplierService.getByName(name).orElse(null);
        return ResponseEntity.ok(response);
    }
